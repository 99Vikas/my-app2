                    ...
                    <Row style={{ alignItems: 'center', justifyContent: 'center', margin: 30 }}>
                        <Col>
                            <div id="page">
                                ...
                                <p><strong>Telephones : </strong>+91 9452421281 <br /><strong>Email : </strong>
                                    <a href="mailto:crb@rb.railnet.gov.in">crb@rb.railnet.gov.in</a>
                                    <span style={{ display: 'none' }}>This e-mail address is being protected from spambots. You need JavaScript enabled to view it
                                        </span>
                                </p>
                                <p><strong>Railway Head Office Exchange Number</strong> : +94 9652421281</p>
                                <p><strong>Fort Railway Station Inquiries</strong> : +94 7072434215</p>
                                <p><strong>Deputy Operating Superintendent</strong> : +94 8928687099</p>
                                <p className="MsoNormal"><strong>Assistant Transportation Superintendent (Operation)</strong> : +94 9542692286</p>
                            </div>
                        </Col>
                    </Row>
                </Col>
